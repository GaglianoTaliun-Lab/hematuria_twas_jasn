...
# saves new files in the /home/renal_genetics_project/multixcan_output/ folder with the prefix "qvalues_"
...
write.table(fdr_threshold, "/home/fridald4/projects/def-gsarah/fridald4/renal_genetics_project/multixcan_output/FDR_threshold.tsv", row.names = F, quote = F, sep = "\t")
