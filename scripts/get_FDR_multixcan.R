...
# saves new files in the /home/hematuria_project/multixcan_output/ folder with the prefix "qvalues_"
...
write.table(fdr_threshold, "/home/fridald4/projects/def-gsarah/fridald4/hematuria_project/multixcan_output/FDR_threshold.tsv", row.names = F, quote = F, sep = "\t")
