...
args <-
  list(
    ...
    loc_file = here(project_dir,"MR_analysis","lava","input_data","gwas_filtered_egfr_acr.loci"),
    info_file = here(project_dir,"MR_analysis","lava","input_data","input.info.acr.egfr.txt"),
    sample_overlap_file = here(project_dir,"MR_analysis","lava","input_data","sample_overlap_acr_egfr.txt"),
...
out_dir <- here(project_dir,"MR_analysis","lava","results")
