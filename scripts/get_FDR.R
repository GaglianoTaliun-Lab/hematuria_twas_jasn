...
# saves new files in the /home/kidney_genetics_project/spredixcan_output/*qtl/ folder with the prefix "qvalues_"
...
for (QTL in c("eqtl", "sqtl")) {
  ...
  home_dir = paste("/home/fridald4/projects/def-gsarah/fridald4/kidney_genetics_project/spredixcan_output/", QTL, sep="")
...
write.table(fdr_threshold, "/home/fridald4/projects/def-gsarah/fridald4/kidney_genetics_project/spredixcan_output/FDR_threshold_per_tissue.csv", row.names = F, quote = F, sep = "\t")
