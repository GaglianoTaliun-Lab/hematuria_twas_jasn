...
file_path <- file.path(project_dir, "MR_analysis/ldsc_corr/593.sumstats.gz")
...
write.table(hematuria, here(project_dir, "MR_analysis", "lava", "input_data", "593.lava.gz"), sep = "\t", quote = F, row.names = F)
