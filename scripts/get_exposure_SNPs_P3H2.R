...
snps_main <- c("chr3_190053645_A_G_b38","chr3_190110871_A_G_b38","chr3_190122493_C_G_b38","chr3_190131409_C_T_b38")
snps_proxy_rs12494405 <- "chr3_190105498_T_G_b38"
snps_proxy_palindromic <- c("chr3_190124837_G_A_b38")
snps_proxy_ckdgen <- c("chr3_190084280_T_C_b38","chr3_190125999_A_T_b38")
...
eqtls <- fread(here(project_dir,"MR_analysis","GTEx_data","Nerve_Tibial.v8.EUR.allpairs.chr3.csv"))

# SNP list with rsids and variant_IDs
rsids <- read.table(here(project_dir,"MR_analysis","SNPs_list_P3H2.txt"), sep = "\t", header = T)

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Extract SNPs of interest and get rsid
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

list_all_snps <- c(snps_main, snps_proxy_rs12494405, snps_proxy_palindromic, snps_proxy_ckdgen)

eqtls <- eqtls %>%
  filter(., phenotype_id == "ENSG00000090530.9") %>%
...
eqtls <- eqtls %>%
  mutate(Phenotype = "P3H2_eQTL_NerveTibial",
...
write.table(eqtls, here(project_dir,"MR_analysis","MR_exposures","NerveTibial_EUR_P3H2_exposure.tsv"),
